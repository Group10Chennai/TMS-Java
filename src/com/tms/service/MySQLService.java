...
public interface MySQLService {
	...
	public Response processServiceDetails(TMSTireService existingService, TMSTireInspection inspection, 
			TMSTire tire);
	// public List<> getVehDetails(List<Long> vehIds, int limit, int
	// startIndex);
