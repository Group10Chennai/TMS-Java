...
public class MyConstants {
	...
	public static String LIMIT_REQUIRED = "Please specify limit";
	
	public static String START_INDEX_REQUIRED = "Please specify start index value.";
	
	public static String SPECIFY_LIMIT_START_INDEX_VALUES = "Please specify limit and start index (Integer) values.";
	...
	public static String DEALLOCATING_STATUS_ERROR = "Incorrent status. Status should be " + STATUS_INSTOCK + " or "
			+ STATUS_SCRAPED;

	// Live Data
	public static String LATEST_DATA_INSERT_SUCCESS = "Data inserted successfully";
	public static String LATEST_DATA_INSERT_FAIL = "Unable to insert data.";
	
	public static String LATEST_DATA_UPDATE_SUCCESS = "Data updated successfully";
	public static String LATEST_DATA_UPDATE_FAIL = "Unable to update data.";
	
	public static String LATEST_DATA_GET_FAIL = "Unable to get the live data.";
	...
	public static String SENSOR_ASSIGNED_ALREADY = "This sensor is not assigned to this vehicle";
	...
	public static String DEALLOCATE_SENSOR_SUCCESSFULLY = "Sensor dallocated successfully";
	public static String DEALLOCATE_SENSOR_FAILED = "Sensor deallocation failed";
	...
	public static String TIRE_NUMBER_ID_MISMATCH = "Tire Number and Tire id mismatching. Please try again later.";
	...
	public static double calculateAvgDepth(double depth1, double depth2, double depth3) {
		return Math.round((depth1 + depth2 + depth3) / 3);
	}
}
